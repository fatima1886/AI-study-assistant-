...
// // FIX 1: Use 'let' instead of 'const' so these values can be updated incrementally
// let currentIndex = 0;
// let score = 0;
// let quizData = null; // FIX 2: Global variable to store the API response data safely
...
//       // Reset index and score tracking for new generation runs
//       currentIndex = 0;
//       score = 0;
...
//     // Safety check if questions array is empty or missing
...
//     // Render text data inside layout containers
...
// function scoreOfQuiz() {
//     const selectedInput = document.querySelector('input[type="radio"]:checked');

//     if (selectedInput) {
//         const selectedText = selectedInput.nextElementSibling.textContent;
//         const correctAnswer = quizData.questions[currentIndex].correctAnswer;

//         if (selectedText === correctAnswer) {
//             score++;
//             console.log("Correct! Current score:", score);
//         } else { 
//             console.log("Incorrect. The right answer was:", correctAnswer);
//         }
//     } else {
...
// // FIX 3: Correct event argument passing and structural flow
// nextbtn.addEventListener("click", () => {

//     if (!quizData) return;

//     // 1. Process score calculation for current active view
//     scoreOfQuiz();

//     // 2. Increment question tracker index
//     currentIndex++;

//     // 3. Evaluate if quiz loop has remaining items or completed loop path
//     if (currentIndex < quizData.questions.length) {
//         placingElements();
//     } else {
//         questionAny.textContent = `Quiz Finished! Your total score is: ${score} / ${quizData.questions.length}`;
//         // Hide option rows or clear elements when completed
